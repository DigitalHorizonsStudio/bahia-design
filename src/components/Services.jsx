...
export const Services = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center mx-auto sm: px-4 sm: py-0 py-6 px-20 pb-20 bg-service">
      <h1 className="text-3xl sm:text-5xl xl:text-6xl md:text-black sm: mb-2 sm: pt-8 xl:mt-10 text-center font-semibold cl-title " style={{ fontFamily: 'Montserrat' }}>Nuestros Proveedores</h1>
