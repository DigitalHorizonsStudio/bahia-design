...
export const Services = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center mx-auto sm: px-4 sm: py-0 py-6 px-20 pb-20 bg-service">
      <h1 className="text-3xl sm:text-5xl xl:text-6xl md:text-black sm: mb-2 sm: pt-8 xl:mt-10 text-center font-semibold cl-title " style={{ fontFamily: 'Montserrat' }}>Proveedores</h1>
      <h1 className="text-xl sm:text-4xl xl:text-4xl md:text-black sm: mb-4 text-center sm:pt-3 sm:pb-6 font-semibold cl-title opacity-80" style={{ fontFamily: 'Montserrat' }}>test</h1>
      
     
      <div className="w-[70%] h-10 grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 lg:pt-6 sm:gap-0 lg:pb-6 sm:pb-0 lg:gap-10 ">

        <ServiceLink image={grifo} title="Griferia" onClick={() => handleServiceClick("Griferia")} />
        <ServiceLink image={pisos} title="Pisos y porcelanatos" onClick={() => handleServiceClick("Pisos")} />
